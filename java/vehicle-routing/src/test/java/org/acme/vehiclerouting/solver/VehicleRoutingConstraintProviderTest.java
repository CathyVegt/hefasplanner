...
//        Vehicle vehicleA = new Vehicle("1", LOCATION_1, TOMORROW_07_00);
//        Visit visit1 = new Visit("2", "John", LOCATION_2, TOMORROW_08_00, TOMORROW_10_00, Duration.ofMinutes(30L));
...
//    }
    ...
    void unassignedPenalizedByDuration() {
        Visit visit = new Visit("2", "John", LOCATION_2, TOMORROW_08_00, TOMORROW_10_00, Duration.ofMinutes(30L));
...
//    }
    ...
    void totalDrivingTime() {
        ...
        Visit visit1 = new Visit("2", "John", LOCATION_2, TOMORROW_08_00, TOMORROW_10_00, Duration.ofMinutes(30L));
        vehicleA.getVisits().add(visit1);
        Visit visit2 = new Visit("3", "Paul", LOCATION_3, TOMORROW_08_00, TOMORROW_10_00, Duration.ofMinutes(30L));
        vehicleA.getVisits().add(visit2);
    ...
    void serviceFinishedAfterMaxEndTime() {
        ...
        Visit visit1 = new Visit("2", "John", LOCATION_2, TOMORROW_08_00, tomorrow_18_00, Duration.ofHours(1L));
        visit1.setArrivalTime(tomorrow_08_40);
        Visit visit2 = new Visit("3", "Paul", LOCATION_3, TOMORROW_08_00, TOMORROW_09_00, Duration.ofHours(1L));

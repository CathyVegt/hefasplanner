...
//            this.maxVehicleCapacity = maxVehicleCapacity;
    ...
    private VehicleRoutePlan buildLargeFixedData(DemoData demoData) {
        ...
        List<Vehicle> vehicles = List.of(
                new Vehicle("0", new Location(51.9280971524736, 6.07789246810776), vehicleStart),
                new Vehicle("1", new Location(52.3664726276756, 5.2098416475017), vehicleStart),
                new Vehicle("2", new Location(51.9280971524736, 6.07789246810776), vehicleStart),
                new Vehicle("3", new Location(51.2497466602742, 5.89418211851084), vehicleStart),
                new Vehicle("4", new Location(51.2497466602742, 6.02661734201217), vehicleStart.plusDays(1)),
                new Vehicle("5", new Location(51.9858536164876, 5.91924254633475), vehicleStart.plusDays(1)),
                new Vehicle("6", new Location(51.9748575231563, 5.95151488262964), vehicleStart.plusDays(1)),
                new Vehicle("7", new Location(52.1500753018447, 5.38056735258708), vehicleStart.plusDays(1)),
                new Vehicle("8", new Location(51.9751431916251, 5.92852542621516), vehicleStart.plusDays(2)),
                new Vehicle("9", new Location(51.8547099653457, 5.81186839499179), vehicleStart.plusDays(2)),
                new Vehicle("10", new Location(51.5066098160184, 5.39401492165828), vehicleStart.plusDays(2)),
                new Vehicle("11", new Location(51.8226143523152, 5.0512912803051), vehicleStart.plusDays(2)),
                new Vehicle("12", new Location(51.3339490380399, 5.98121147978097), vehicleStart.plusDays(3)),
                new Vehicle("13", new Location(51.3339490380399, 5.98121147978097), vehicleStart.plusDays(3)),
                new Vehicle("14", new Location(51.3339490380399, 5.98121147978097), vehicleStart.plusDays(3)),
                new Vehicle("15", new Location(51.3339490380399, 5.98121147978097), vehicleStart.plusDays(3))
        );

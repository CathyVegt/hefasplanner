...
public class VehicleRoutingConstraintProvider implements ConstraintProvider {
    ...
    public static final String SKILLREQUIRED = "skillRequired";
...
//    }
    ...
    protected Constraint requiredSkills(ConstraintFactory factory){
        return factory.forEach(Visit.class)
                .filter(v -> v.getVehicle() != null
                        && !v.getVehicle().getTechnician().hasSkill(v.getBrand(), v.getMinLvl(), v.getTaskType()))
                .penalizeLong(HardMediumSoftLongScore.ONE_HARD)
                .asConstraint(SKILLREQUIRED);
    }

...
public class Vehicle implements LocationAware {
    ...
    private LocalDateTime minStartTime; //earliest possible start of shift
    private LocalDateTime maxEndTime; //latest possible end of shift.
    ...
    public Vehicle(String id, Location homeLocation, LocalDateTime minStartTime, LocalDateTime maxEndTime, LocalDateTime departureTime, Technician technician){
        this.id = id;
    ...
    public Vehicle(String id, Location homeLocation, LocalDateTime departureTime) {
        this.id = id;
        //this.capacity = capacity; we are not dealing with capacity
        this.homeLocation = homeLocation;
        this.departureTime = departureTime;
        this.visits = new ArrayList<>();
//        this.technician = new Technician("name", homeLocation);
    }
